...
mv - f $subject_directory/${subject_list[$i]}/$save_directory_name/${subject_list[$i]}_volume_lobaire_total_espace_natif.csv $subject_directory/${subject_list[$i]}/$save_directory_name/${subject_list[$i]}_volume_lobaire_total_espace_natif.xlsx $subject_directory/${subject_list[$i]}/$save_directory_name/grey_matter_${subject_list[$i]}_volume_natif.csv $subject_directory/${subject_list[$i]}/$save_directory_name/white_matter_${subject_list[$i]}_volume_natif.csv $subject_directory/${subject_list[$i]}/$save_directory_name/w_mni_grey_matter_atlasLobaire_features_${subject_list[$i]}.csv $subject_directory/${subject_list[$i]}/$save_directory_name/w_mni_white_matter_atlasLobaire_features_${subject_list[$i]}.csv $subject_directory/${subject_list[$i]}/$save_directory_name/mni_to_native_grey_matter_atlasLobaire_features_${subject_list[$i]}.csv $subject_directory/${subject_list[$i]}/$save_directory_name/mni_to_native_white_matter_atlasLobaire_features_${subject_list[$i]}.csv $resultats_volumes
